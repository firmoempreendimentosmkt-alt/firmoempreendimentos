    ...
    <section id="sobre" className="py-16 sm:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-balance">Sobre Nós</h2>
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed text-pretty mt-4">
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="border-none shadow-lg">
              <CardContent className="p-4 sm:p-6 text-center">
                <stat.icon className="h-8 w-8 sm:h-10 sm:w-10 mx-auto mb-3 sm:mb-4 text-primary" />
                <div className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2" style={{ color: "#e07b20" }}>
                  {stat.value}
                </div>

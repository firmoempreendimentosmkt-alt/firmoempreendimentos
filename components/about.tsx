    ...
    <section id="sobre" className="py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 text-balance">Sobre Nós</h2>
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed text-pretty mt-4">
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="border-none shadow-lg">
              <CardContent className="p-4 md:p-6 text-center">
                <stat.icon className="h-8 w-8 md:h-10 md:w-10 mx-auto mb-3 md:mb-4 text-primary" />
                <div className="text-2xl md:text-4xl font-bold mb-1 md:mb-2" style={{ color: "#d4a853" }}>{stat.value}</div>
